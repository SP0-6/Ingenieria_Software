...
(function ($) {
  ...
  var profesionalesPorEspecialidad = {
    'clinica-medica': [
      { nombre: 'Dr. Alejandro Romero', matricula: 'MP 12.345' },
      { nombre: 'Dra. Laura Figueroa', matricula: 'MP 14.782' }
    ],
    'cardiologia': [
      { nombre: 'Dr. Martín Herrera', matricula: 'MP 22.918' }
    ],
    'pediatria': [
      { nombre: 'Dra. Valeria Soria', matricula: 'MP 31.450' },
      { nombre: 'Dr. Santiago Peralta', matricula: 'MP 29.631' }
    ],
    'ginecologia': [
      { nombre: 'Dra. Cecilia Navarro', matricula: 'MP 18.204' }
    ],
    'dermatologia': [
      { nombre: 'Dra. Florencia Díaz', matricula: 'MP 35.700' }
    ],
    'traumatologia': [
  ...
  $('#formularioTurno').on('submit', function (e) {
    ...
    setTimeout(function () {
      ...
      var nombreCompleto = $('#turno-nombre').val() + ' ' + $('#turno-apellido').val();
      var especialidad   = $selectEspecialidad.find('option:selected').text();
      var profesional    = $selectProfesional.find('option:selected').text() || 'A confirmar';
      var fecha          = formatearFecha($('#turno-fecha').val());
      var horario        = $('#turno-horario').val();
